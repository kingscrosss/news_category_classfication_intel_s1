...
#     titles.append(re.compile('[^가-힣|a-z|A-Z']).sub(' ', title_tag.text))    # ^: 처음부터라는 의미, sub: ()를 제외하고 ' '로 채워라
...
for i in range(6):
    resp = requests.get('https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=10{}'.format(i),) # 주소 끝부분 100 -> 10{}로 변경
